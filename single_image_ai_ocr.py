...
def save_transcription(image_path: str, transcribed_text: str, output_dir: str = None, validation_results: dict = None) -> str:
    """
...
def save_usage_summary(tracker: TokenTracker, output_file: str, image_path: str, validation_results: dict = None) -> None:
    """
...
def main():
    ...
    # Initialize OpenAI client, tracker, and hallucination detector
